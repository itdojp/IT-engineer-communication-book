...
[OK] **技術者間コミュニケーション**：専門性ギャップと効率化原則  
[OK] **非技術者との連携**：抽象化レベル選択とビジネス価値翻訳  
[OK] **組織階層での情報伝達**：フィルタリングとエスカレーション戦略  
[OK] **コミュニケーション・パターン**：成功パターンとアンチパターン

### 💡 課題解決への体系的アプローチ

これらの理解により、次のことができるようになります。
...
## 実践：同じ内容を「技術者向け」と「非技術者向け」で書き分ける

### 目的

- 抽象度を切り替え、誤解と往復を減らします
- 技術的事実を、意思決定に必要な形へ変換します

### 前提

- 説明したい題材（障害/改善提案/要件変更など）が1つある

### 入力

- 題材（推奨）：[付録1：実践チェックリスト集](../appendix-01-checklists/) の「A11. 演習シナリオ集」から1つ
- 宛先：技術者（同僚）/非技術者（PM・営業など）の2種類

### 手順（5ステップ以内）

1. 題材の「事実/原因/影響/選択肢/提案」を箇条書きにしてください
2. 技術者向けに、専門用語を許容した要約（200〜300字）を書いてください
3. 非技術者向けに、結論→影響→次アクションが先に来る要約（120〜200字）を書いてください
4. [付録1：実践チェックリスト集](../appendix-01-checklists/) の「A3. 非同期依頼チェックリスト」で抜け漏れを確認してください
5. 実際に送るメッセージとして整形し、必要なら [付録2：テンプレート・フォーマット集](../appendix-02-templates/) の「T1/T4」を併記してください

### 成果物

- 技術者向け要約（1本）
- 非技術者向け要約（1本）
- 追加質問を減らす前提リンク（必要ならContext Package）

### 測定（KPI例）

- 追加質問の往復回数（例：スレッド返信数）
- 決定までのリードタイム（例：初回共有→合意）
- 手戻りの発生回数（例：前提誤解による作り直し）

### 典型失敗とリカバリ

- 失敗：非技術者向けでも専門用語が多い → リカバリ：比喩/具体例に置き換え、目的と影響を先に書く
- 失敗：結論が最後になる → リカバリ：1行目に「結論」を固定する（PREP）

### 次の一手

- 依頼文を型にしたい → [付録2：テンプレート・フォーマット集](../appendix-02-templates/) の「T4. 非同期依頼」
- 会議で意思決定したい → [付録2：テンプレート・フォーマット集](../appendix-02-templates/) の「T2/T3」＋ [付録1：実践チェックリスト集](../appendix-01-checklists/) の「A1/A2」

---

## 次章への橋渡し

課題を理解したら、次は具体的な解決手法へ進みましょう。

- **すぐに実践したい** → 第3章「[構造化コミュニケーション手法](../chapter-structured-communication/)」
- **特定の相手との連携を改善したい** → 第4章「[ステークホルダー別コミュニケーション戦略](../chapter-stakeholder-communication/)」
- **デジタルツールを活用したい** → 第5章「[デジタルコミュニケーション最適化](../chapter-digital-communication/)」
- **組織全体の改善を目指す** → 第9章「[技術リーダーシップとコミュニケーション](../chapter-technical-leadership/)」

あなたが最も解決したい課題に応じて、最適な学習パスを選択してください。

迷ったら次章（第3章）から読み進めてください: [構造化コミュニケーション手法](../chapter-structured-communication/)
