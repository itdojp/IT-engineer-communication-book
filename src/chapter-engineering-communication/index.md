...
[OK] **システム思考**：全体性・因果関係・抽象化・最適化の強み  
[OK] **論理的推論**：演繹・帰納・仮説検証の思考パターン  
[OK] **詳細志向**：品質へのこだわりと対人コミュニケーションでの課題  
[OK] **認知負荷**：ワーキングメモリの制約と最適化戦略
...
4. 次週の改善仮説を1つ作ってください（例：「依頼文は Context Package で統一する」）
...
- AI で要約/下書きを作る場合 → [付録1：実践チェックリスト集](../appendix-01-checklists/) の「A10. AI支援を使う前のチェックリスト」
