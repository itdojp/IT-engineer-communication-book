...
## A0. Phase 6 実務コミュニケーション運用ゲート

報告、相談、合意形成、フィードバック、非同期連絡を開始する前に確認する。

- [ ] 目的と文脈（何を決める/伝える/相談するか、背景、制約）が1文で説明できる
- [ ] 責任分界（依頼者、判断者、レビュー担当、実行担当、次回更新者）が明確である
- [ ] 非同期運用（期限、返信期待、必要リンク、エスカレーション条件）が書かれている
- [ ] 記録先（Issue、PR、ADR、議事録、Runbook）が決まっている
- [ ] 決定事項、未決事項、次アクション、振り返り観点を残す運用になっている
- [ ] 交渉が必要な利害調整は、交渉系のテンプレートへ切り出す
- [ ] AI支援を使う場合は、A10のガードレールを先に適用する

<span id="a1" aria-hidden="true"></span>
...
<span id="a3" aria-hidden="true"></span>
...
<span id="a5" aria-hidden="true"></span>
...
<span id="a9" aria-hidden="true"></span>
## A9. 1on1準備チェックリスト
