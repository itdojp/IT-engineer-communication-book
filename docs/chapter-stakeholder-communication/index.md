...
## 実践：意思決定者向け「1ページ要約」と詳細版をセットで作る

### 目的

- ステークホルダーごとの判断材料を揃え、合意形成を加速します
- 「説明」と「意思決定」を分離し、議論を前に進めます

### 前提

- 何か決めたいテーマ（仕様変更、優先度調整、リスク対応）が1つある

### 入力

- 題材（推奨）：[付録1：実践チェックリスト集](../appendix-01-checklists/) の「A11. 演習シナリオ集」から1つ
- 選択肢（最低2つ）と、それぞれのメリット/デメリット/リスク

### 手順（5ステップ以内）

1. 「決めたいこと」と「決めないこと」を1行で書いてください
2. 意思決定者向けに、結論/影響/必要な判断だけの要約（1ページ、または5行）を書いてください
3. 詳細版として、[付録2：テンプレート・フォーマット集](../appendix-02-templates/) の「T6. 仕様変更提案（RFC）」または「T7. ADR」に沿って、選択肢と根拠を整理してください
4. 共有前に、[付録1：実践チェックリスト集](../appendix-01-checklists/) の「A1. 会議前チェックリスト」または「A3. 非同期依頼チェックリスト」で不足を確認してください
5. 利害調整が必要なら、[付録2：テンプレート・フォーマット集](../appendix-02-templates/) の「T11. 交渉前の論点整理シート」で論点を切り出してください
...
- 失敗：技術詳細だけで説明する → リカバリ：影響（ユーザー/コスト/納期）を先に書く
- 失敗：論点が増え続ける → リカバリ：論点は最大3つに絞り、それ以外は宿題にする
...
- **デジタルツールでさらに効率化したい** → 第5章「[デジタルコミュニケーション最適化](../chapter-digital-communication/)」
- **メンタルヘルス管理に関心がある** → 第6章「[エンジニア特有のストレス要因分析](../chapter-stress-analysis/)」
...
迷ったら次章（第5章）から読み進めてください: [デジタルコミュニケーション最適化](../chapter-digital-communication/)
